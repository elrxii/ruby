...
#  This program will read a command and -
#  display what action will be completed.
...
class Square
  ...
  def initialize
	...
	#for pushing contents
	#these three stacks are associative
	@centerPointStack = Array.new()
	@lengthStack = Array.new()
	@cmdStack = Array.new()
	
	#used as a temporary stack in case of undo/redo
	# These stacks are associative
  ...
  # Pulling "otherStack" (temporary stack) contents and pushing
  # onto main stack
  def redo
